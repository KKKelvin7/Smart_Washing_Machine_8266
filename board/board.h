...
#define BOARD_ESP8266_UART_BASEADDR          LPUART3
#define BOARD_ESP8266_UART_CLK_FREQ          BOARD_DebugConsoleSrcFreq()
#define BOARD_ESP8266_UART_IRQn              LPUART3_IRQn
#define BOARD_ESP8266_UART_IRQHandler        LPUART3_IRQHandler
...
#define BOARD_ESP8266_UART_TX_IOMUX          IOMUXC_GPIO_AD_B1_06_LPUART3_TX
#define BOARD_ESP8266_UART_RX_IOMUX          IOMUXC_GPIO_AD_B1_07_LPUART3_RX
...
/* The UART to use for wifi module. */
#define BOARD_DEBUG_UART_TYPE                kSerialPort_Uart
